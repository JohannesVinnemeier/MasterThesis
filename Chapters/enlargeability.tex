...
\begin{theorem}[{\cite[Thm. 1.3]{BrunnbauerHanke}}]
    Let $M$ be a closed oriented $n$-manifold and let $\phi \colon M \to B\pi_1(M)$ be a classifying map of the universal cover. Then there exists a rational vector subspace 
    \[
